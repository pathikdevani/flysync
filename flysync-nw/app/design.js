...
function home_module() {
    ...
    $social.bindData({
        "facebook": function () {
            opener.open("https://www.facebook.com/photo.php?fbid=612811792203439&set=a.106730739478216.17472.100004238705306&type=3&permPage=1");
        },
        "twitter": function () {
            opener.open("https://twitter.com/pathik_devani/status/721073813371269120");
        },
        "github": function () {
            opener.open("https://github.com/pathikdevani/Flysync");
        }
